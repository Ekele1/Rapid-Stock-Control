        ...
        <div className="leftside">
          ...
          <div className="optionschose">
            <div onClick={handleDashboard}>
              <aside
                className={`a1 ${change.name === "dashboard" ? "xxx" : null}`}
              >
                <MdOutlineDashboard />
              </aside>
              <aside
                className={`a2 ${change.name === "dashboard" ? "xxx" : null}`}
              >
                <p>Dashboard</p>
              </aside>
            </div>
            ...
            <div onClick={handlePurchase}>
              <aside
                className={`a1 ${change.name === "purchase" ? "xxx" : null}`}
              >
                <IoMdCart />
              </aside>
              <aside
                className={`a2 ${change.name === "purchase" ? "xxx" : null}`}
              >
                <p>Purchases</p>
              </aside>
            </div>
            <div onClick={handleProduct}>
              <aside
                className={`a1 ${change.name === "product" ? "xxx" : null}`}
              >
                <FaBoxOpen />
              </aside>
              <aside
                className={`a2 ${change.name === "product" ? "xxx" : null}`}
              >
                <p>Product MGT</p>
              </aside>
            </div>
          ...
          {dropmenu ? (
            <div className="rightmenudivitem">
              <p
                ...
                className={`ay ${change.name === "dashboard" ? "ax" : null}`}
              >
                Dashboard
              </p>
              <p
                onClick={handleSales}
                className={`ay ${change.name === "sales" ? "ax" : null}`}
              >
                Sales
              </p>
              <p
                onClick={handlePurchase}
                className={`ay ${change.name === "purchase" ? "ax" : null}`}
              >
                Purchases
              </p>
              <p
                onClick={handleProduct}
                className={`ay ${change.name === "product" ? "ax" : null}`}
              >
                Product Mgt
              </p>
              <p
                onClick={handleOrder}
                className={`ay ${change.name === "order" ? "ax" : null}`}
              >
                Order Mgt
              </p>
              <p
                onClick={handleNotification}
                className={`ay ${change.name === "notification" ? "ax" : null}`}
              >
                LogOut
              </p>
